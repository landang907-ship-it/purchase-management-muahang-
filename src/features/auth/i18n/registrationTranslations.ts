...
const VI: TranslationMap = {
    'register.title': 'Đăng ký tài khoản mới (注册新账户)',
    'register.show': 'Đăng ký (注册)',
    'register.hide': 'Ẩn (隐藏)',
    ...
    'register.submit': 'ĐĂNG KÝ (注册)',
    'register.userRequired': 'Vui lòng nhập USER (请输入用户)',
    'register.passwordRequired': 'Vui lòng nhập mật khẩu (请输入密码)',
    'register.passwordMismatch': 'Mật khẩu không khớp (密码不匹配)',
    'register.success': 'Đăng ký thành công! Vui lòng đăng nhập. (注册成功！请登录。)',
    'register.successDetail': 'Vui lòng sử dụng thông tin đã đăng ký để đăng nhập. (请使用注册的账户信息登录。)',
    'register.close': 'Đóng (关闭)',
};
